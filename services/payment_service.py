...
def generar_formulario_pago(id_proyecto, descripcion, valor, email_cliente):
    ...
    <form method="post" action="{PAYU_URL}" id="payuForm">
      ...
      <input name="responseUrl"   type="hidden"  value="/pasarela/api/pagos/respuesta">
      <input name="confirmationUrl" type="hidden" value="/pasarela/api/pagos/confirmacion-pago">
